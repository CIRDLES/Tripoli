...
public class TripoliSpeciesColorMap_0 implements Map<Integer, SpeciesColors>, Serializable{
//  TODO: make this work for SpeciesRecordInterface
    private final Map<Integer, SpeciesColors> mapOfSpeciesToColors;

    public TripoliSpeciesColorMap_0() {
        super();
        mapOfSpeciesToColors = Collections.synchronizedSortedMap(new TreeMap<>());
    }

    public TripoliSpeciesColorMap_0(Map<Integer, SpeciesColors> other) {
        this();
