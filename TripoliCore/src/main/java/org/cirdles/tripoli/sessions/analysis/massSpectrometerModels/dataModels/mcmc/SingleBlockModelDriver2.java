...
import static org.cirdles.tripoli.sessions.analysis.massSpectrometerModels.dataModels.mcmc.SingleBlockModelInitForMCMC2.initializeModelForSingleBlockMCMC2;

/**
 * @author James F. Bowring
 */
public enum SingleBlockModelDriver2 {
    ;
    ...
    private static SingleBlockDataSetRecord prepareSingleBlockDataForMCMC2(int blockNumber, MassSpecExtractedData massSpecExtractedData, AnalysisMethod analysisMethod) {
