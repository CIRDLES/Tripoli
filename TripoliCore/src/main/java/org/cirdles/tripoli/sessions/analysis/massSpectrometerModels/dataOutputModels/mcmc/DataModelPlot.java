...
public class DataModelPlot {
    ...
    public static AbstractPlotBuilder[][] analysisAndPlotting(
        ...
        for (int blockIndex = 0; blockIndex < blockCount; blockIndex++) {
            ...
            MatrixStore<Double> yDataMatrix = massSpecOutputDataRecord.allBlockInterpolations().get(blockIndex).multiply(intensityMeansMatrix).multiply((1.0 / (dalyFaradayGainMean * 6.24e7)) * 1e6);
