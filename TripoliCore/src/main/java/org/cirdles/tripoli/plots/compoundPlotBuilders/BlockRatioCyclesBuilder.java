...
//    private static final long serialVersionUID = 9180059676626735662L;
    protected BlockCyclesRecord blockRatioCyclesRecord;
    ...
    protected BlockCyclesRecord generateBlockCyclesPlot(int blockID, boolean processed, double dalyFaradayGain, double[] cycleLogRatioMeansdata, double[] cycleLogRatioOneSigmaData, boolean[] cyclesIncluded, String[] title, String xAxisLabel, boolean blockIncluded) {
