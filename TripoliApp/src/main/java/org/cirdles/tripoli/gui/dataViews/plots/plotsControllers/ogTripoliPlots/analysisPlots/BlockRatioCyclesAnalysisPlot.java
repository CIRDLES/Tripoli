...
public class BlockRatioCyclesAnalysisPlot extends AbstractPlot {
    ...
    private Map<Integer, BlockCyclesRecord> mapBlockIdToBlockRatioCyclesRecord;
    ...
    public Map<Integer, BlockCyclesRecord> getMapBlockIdToBlockRatioCyclesRecord() {
    ...
    public void preparePanel(boolean reScaleX, boolean reScaleY) {
        ...
        for (Map.Entry<Integer, BlockCyclesRecord> entry : mapBlockIdToBlockRatioCyclesRecord.entrySet()) {
            BlockCyclesRecord blockRatioCyclesRecord = entry.getValue();
