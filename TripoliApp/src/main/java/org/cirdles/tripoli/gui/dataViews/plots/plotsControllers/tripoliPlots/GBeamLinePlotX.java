...
public class GBeamLinePlotX extends AbstractDataView {
     ...
     */
    public GBeamLinePlotX(Rectangle bounds, GBeamLinePlotBuilder gBeamLinePlotBuilder) {
        super(bounds, 50, 35);
    ...
    public void paint(GraphicsContext g2d) {
        ...
        g2d.fillText(gBeamLinePlotBuilder.getTitle().toString(), 20, 20);
