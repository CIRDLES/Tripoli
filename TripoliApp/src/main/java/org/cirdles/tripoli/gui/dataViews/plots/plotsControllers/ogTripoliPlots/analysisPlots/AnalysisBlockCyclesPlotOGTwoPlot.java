 ...
 */
public class AnalysisBlockCyclesPlotOGTwoPlot extends AbstractPlot implements AnalysisBlockCyclesPlotI {
    ...
    private AnalysisBlockCyclesPlotOGTwoPlot(
    ...
    public static AbstractPlot generatePlot(
        ...
        return new AnalysisBlockCyclesPlotOGTwoPlot(analysis, bounds, userFunction, blockIDsPerTimeSlot, parentWallPane);
    }
    ...
    public void preparePanel(boolean reScaleX, boolean reScaleY) {
        ...
        if (reScaleX) {
            ...
            setOnMouseDragged(new AnalysisBlockCyclesPlotOGTwoPlot.MouseDraggedEventHandler());
            setOnMousePressed(new AnalysisBlockCyclesPlotOGTwoPlot.MousePressedEventHandler());
            setOnMouseReleased(new AnalysisBlockCyclesPlotOGTwoPlot.MouseReleasedEventHandler());
...
//            }
    ...
    public void sculptBlock(boolean zoomBlock) {
        if ((0 < sculptBlockID) && !inSculptorMode) {
            ...
            setOnMouseDragged(new AnalysisBlockCyclesPlotOGTwoPlot.MouseDraggedEventHandlerSculpt());
            setOnMousePressed(new AnalysisBlockCyclesPlotOGTwoPlot.MousePressedEventHandlerSculpt());
            setOnMouseReleased(new AnalysisBlockCyclesPlotOGTwoPlot.MouseReleasedEventHandlerSculpt());
            selectorBoxX = mouseStartX;
            selectorBoxY = mouseStartY;
