...
public class FlavoredIndexedColorSplotch extends FlavoredIndexedLabel {

    private Color color;

    public FlavoredIndexedColorSplotch(String text, DetectorPlotFlavor plotFlavor, Color color, int index) {
